...
export default function ContactButton({ label = 'Contáctame', onClick, href }: Props) {
  ...
  const classes = "inline-flex items-center gap-3 px-8 py-4 md:px-10 md:py-5 rounded-full font-syne font-bold text-sm tracking-widest uppercase text-white transition-transform duration-250 hover:-translate-y-1"
  const btnStyle = {
