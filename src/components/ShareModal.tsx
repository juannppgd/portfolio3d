    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 flex items-center justify-center z-[60] px-4 py-6"
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-sm p-6 md:p-8 rounded-3xl"
          ...
          >
            ...
            <div className="text-center mb-6">
              ...
              <h3 className="font-syne font-black text-xl mb-1" style={{ color: 'var(--text)' }}>
                Comparte este{' '}
                <span className="gradient-heading">sitio</span>
              </h3>
              <p className="font-mono text-xs" style={{ color: 'var(--muted)' }}>
                Elige cómo quieres compartir esta página
              </p>
            </div>
